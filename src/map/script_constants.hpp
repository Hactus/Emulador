...
#define SCRIPT_CONSTANTS_HPP
	...
	export_constant(MF_RANKED_KILL_POINTS_GAIN);
	export_constant(MF_RANKED_KILL_POINTS_DROP);
	export_constant(MF_RANKED_SUPPORT_POINTS);
#endif
...
/// Do not modify code above this, since it will be automatically generated by the API again
	...
	export_constant(IG_BALLON_PORING);
	export_constant(IG_MVPCARDALBUM);
