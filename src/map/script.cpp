...
#include "../creativesd/stuff/stuff.hpp"
#endif
...
#include "../creativesd/bindclock/bindclock.hpp"
#endif
#ifdef CREATIVE_SCRIPTCMD_ENABLE
#include "../creativesd/scriptcommand/script.hpp"
#endif
...
bool script_rid2sd_( struct script_state *st, struct map_session_data** sd, const char *func ){
	*sd = map_id2sd( st->rid );
...
BUILDIN_FUNC(warpparty)
{
	...
	for (i = 0; i < MAX_PARTY; i++)
	{
		...
		case 1: // SavePointAll
			...
			if(!map_getmapflag(pl_sd->bl.m, MF_NORETURN) || !pc_is_on_cellpvp(sd) )
#else
...
#ifdef CELL_PVP_ENABLE
			if((!map_getmapflag(pl_sd->bl.m, MF_NORETURN) || !pc_is_on_cellpvp(sd)) && !map_getmapflag(pl_sd->bl.m, MF_NOWARP) && pc_job_can_entermap((enum e_job)pl_sd->status.class_, m, pl_sd->group_level))
#else
...
#ifdef CELL_PVP_ENABLE
			case UMOB_X: if (!unit_walktoxy(bl, (short)value, md->bl.y, 2)) unit_movepos(bl, (short)value, md->bl.y, 0, 0, 0); break;
			case UMOB_Y: if (!unit_walktoxy(bl, md->bl.x, (short)value, 2)) unit_movepos(bl, md->bl.x, (short)value, 0, 0, 0); break;
#else
...
#ifdef CELL_PVP_ENABLE
			case UHOM_X: if (!unit_walktoxy(bl, (short)value, hd->bl.y, 2)) unit_movepos(bl, (short)value, hd->bl.y, 0, 0, 0); break;
			case UHOM_Y: if (!unit_walktoxy(bl, hd->bl.x, (short)value, 2)) unit_movepos(bl, hd->bl.x, (short)value, 0, 0, 0); break;
#else
...
#ifdef CELL_PVP_ENABLE
			case UPET_X: if (!unit_walktoxy(bl, (short)value, pd->bl.y, 2)) unit_movepos(bl, (short)value, md->bl.y, 0, 0, 0); break;
			case UPET_Y: if (!unit_walktoxy(bl, pd->bl.x, (short)value, 2)) unit_movepos(bl, pd->bl.x, (short)value, 0, 0, 0); break;
#else
...
#ifdef CELL_PVP_ENABLE
			case UMER_X: if (!unit_walktoxy(bl, (short)value, mc->bl.y, 2)) unit_movepos(bl, (short)value, mc->bl.y, 0, 0, 0); break;
			case UMER_Y: if (!unit_walktoxy(bl, mc->bl.x, (short)value, 2)) unit_movepos(bl, mc->bl.x, (short)value, 0, 0, 0); break;
#else
...
#ifdef CELL_PVP_ENABLE
			case UELE_X: if (!unit_walktoxy(bl, (short)value, ed->bl.y, 2)) unit_movepos(bl, (short)value, ed->bl.y, 0, 0, 0); break;
			case UELE_Y: if (!unit_walktoxy(bl, ed->bl.x, (short)value, 2)) unit_movepos(bl, ed->bl.x, (short)value, 0, 0, 0); break;
#else
...
#ifdef CELL_PVP_ENABLE
			case UNPC_X: if (!unit_walktoxy(bl, (short)value, nd->bl.y, 2)) unit_movepos(bl, (short)value, nd->bl.x, 0, 0, 0); break;
			case UNPC_Y: if (!unit_walktoxy(bl, nd->bl.x, (short)value, 2)) unit_movepos(bl, nd->bl.x, (short)value, 0, 0, 0); break;
#else
...
BUILDIN_FUNC(mimic) {
	...
	if (!script_rid2sd(sd) || (!pc_checkskill(sd, RG_PLAGIARISM) && !pc_checkskill(sd, SC_REPRODUCE)))
		return SCRIPT_CMD_SUCCESS;

	switch (flag) {
		case 0: // Copiado por Plagio.
			{
	...
	clif_skillinfoblock(sd); // Updates whole skill tree.
	return 0;
}
 ...
 *------------------------------------------*/
#include "../creativesd/queue/script_func.inc"
#endif
 ...
 *------------------------------------------*/
#include "../creativesd/bgwarfare/script_func.inc"
#endif
 ...
 *------------------------------------------*/
#include "../creativesd/ranked/script_func.inc"
#endif
 ...
 *------------------------------------------*/
#include "../creativesd/stuff/script_func.inc"
#endif
 ...
 *------------------------------------------*/
#include "../creativesd/restock/script_func.inc"
#endif
 ...
 *------------------------------------------*/
#include "../creativesd/oshops/script_func.inc"
#endif
 ...
 * [CreativeSD]: Bind Clock
 *------------------------------------------*/
#include "../creativesd/bindclock/script_func.inc"
#endif

#ifdef COSTUME_SYSTEM_ENABLE
/*==========================================
 * [CreativeSD]: Costume Items
 *------------------------------------------*/
#include "../creativesd/costume/script_func.inc"
#endif

#ifdef CREATIVE_SCRIPTCMD_ENABLE
/*==========================================
 * [CreativeSD]: Script Commands
 *------------------------------------------*/
#include "../creativesd/scriptcommand/script_func.inc"
#endif
...
#include "../creativesd/queue/script_def.inc"
#endif

#ifdef BG_WARFARE_ENABLE
	// [CreativeSD] Battleground Warfare
#include "../creativesd/bgwarfare/script_def.inc"
#endif

#ifdef RANKED_SYSTEM_ENABLE
	// [CreativeSD]: Ranked System
#include "../creativesd/ranked/script_def.inc"
#endif

#ifdef STUFF_ITEMS_ENABLE
	// [CreativeSD]: Stuff Items
#include "../creativesd/stuff/script_def.inc"
#endif

#ifdef RESTOCK_SYSTEM_ENABLE
	// [CreativeSD]: Restock System
#include "../creativesd/restock/script_def.inc"
#endif

#ifdef OSHOPS_ENABLE
	// [CreativeSD]: Organized Shops
#include "../creativesd/oshops/script_def.inc"
#endif

#ifdef BIND_CLOCK_ENABLE
	// [CreativeSD]: Bind Clock
#include "../creativesd/bindclock/script_def.inc"
#endif

#ifdef COSTUME_SYSTEM_ENABLE
	// [CreativeSD]: Costume System
#include "../creativesd/costume/script_def.inc"
#endif

#ifdef CREATIVE_SCRIPTCMD_ENABLE
	// [CreativeSD]: Script Commmands
#include "../creativesd/scriptcommand/script_def.inc"
#endif
#ifdef REFINE_UI_ENABLE
