...
#define unit_movepos(bl, dst_x, dst_y, easy, checkpath, skilluse) unit_movepos_sub(bl, dst_x, dst_y, easy, checkpath, skilluse)
#else
#define unit_movepos(bl, dst_x, dst_y, easy, checkpath) unit_movepos_sub(bl, dst_x, dst_y, easy, checkpath, 0)
#endif
