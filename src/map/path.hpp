...
#define path_search(bl, wpd, m, x0, y0, x1, y1, flag, cell) path_search_sub(bl, wpd, m, x0, y0, x1, y1, flag, cell)
#else
#define path_search(wpd, m, x0, y0, x1, y1, flag, cell) path_search_sub(NULL, wpd, m, x0, y0, x1, y1, flag, cell)
#endif
