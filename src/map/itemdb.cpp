...
#ifdef EXTENDED_VENDING_ENABLE
		sv_readdb(dbsubpath1, "item_vending.txt",		',', 1, 1, ARRAYLENGTH(item_vend), &itemdb_read_vending, i); // [CreativeSD/Lilith] Extended Vending system
#endif
#ifdef RENEWAL
...
#ifdef EXTENDED_VENDING_ENABLE
	memset(item_vend, 0, sizeof(item_vend)); // [CreativeSD/Lilith] Extended Vending system
#endif
