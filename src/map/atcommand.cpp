...
#include "../creativesd/atcommand/atcommand.hpp"
#endif
...
ACMD_FUNC(hide)
{
	...
	if (pc_isinvisible(sd)) {
		...
		if( !battle_config.pk_mode && (map_getmapflag(sd->bl.m, MF_PVP) || pc_is_on_cellpvp(sd)) && !map_getmapflag(sd->bl.m, MF_PVP_NOCALCRANK) )
#else
...
#ifdef RANKED_SYSTEM_ENABLE
	if (map_getmapflag(m_id, MF_RANKED))
...
#ifdef CELL_PVP_ENABLE
	if (map_getmapflag(m_id, MF_NORETURN) || pc_is_on_cellpvp(sd))
#else
...
ACMD_FUNC(autotrade) {
	...
	{
		int presence = pc_readaccountreg(sd, add_str("PresenceFlag"));
		if (presence) {
 ...
 *------------------------------------------*/
#include "../creativesd/queue/atcommand_func.inc"
#endif
 ...
 *------------------------------------------*/
#include "../creativesd/bgwarfare/atcommand_func.inc"
#endif
 ...
 * [CreativeSD]: Ranked System
 *------------------------------------------*/
#include "../creativesd/ranked/atcommand_func.inc"
#endif
 ...
 *------------------------------------------*/
#include "../creativesd/stuff/atcommand_func.inc"
#endif
 ...
 *------------------------------------------*/
#include "../creativesd/restock/atcommand_func.inc"
#endif
 ...
 *------------------------------------------*/
#include "../creativesd/oshops/atcommand_func.inc"
#endif
 ...
 *------------------------------------------*/
#include "../creativesd/costume/atcommand_func.inc"
#endif
  ...
  *------------------------------------------*/
#include "../creativesd/arealoot/atcommand_func.inc"
#endif

#ifdef CREATIVE_ATCMD_ENABLE
 /*==========================================
  * [CreativeSD]: Others Atcommands
  *------------------------------------------*/
#include "../creativesd/atcommand/atcommand_func.inc"
#endif
...
ACMD_FUNC(refineui)
{
	...
	clif_displaymessage(fd, msg_txt(sd, REFINE_UI_MSG_TXT)); // This command requires packet version 2016-10-12 or newer.
	return -1;
#else
	if( !battle_config.feature_refineui ){
		clif_displaymessage(fd, msg_txt(sd, (REFINE_UI_MSG_TXT+1))); // This command is disabled via configuration.
		return -1;
	}
 	if( sd->state.refineui_open ){
		clif_displaymessage(fd, msg_txt(sd, (REFINE_UI_MSG_TXT+2))); // You have already opened the refine UI.
		return -1;
	}
...
#include "../custom/atcommand_def.inc"
	 ...
	 * [CreativeSD]: Queue System
	 *------------------------------------------*/
#include "../creativesd/queue/atcommand_def.inc"
#endif
#ifdef BG_WARFARE_ENABLE
	 /*==========================================
	  * [CreativeSD]: Battleground Warfare
	  *------------------------------------------*/
#include "../creativesd/bgwarfare/atcommand_def.inc"
#endif
#ifdef RANKED_SYSTEM_ENABLE
	/*==========================================
	 * [CreativeSD]: Ranked System
	 *------------------------------------------*/
#include "../creativesd/ranked/atcommand_def.inc"
#endif
#ifdef STUFF_ITEMS_ENABLE
	/*==========================================
	 * [CreativeSD]: Stuff Items
	 *------------------------------------------*/
#include "../creativesd/stuff/atcommand_def.inc"
#endif
#ifdef RESTOCK_SYSTEM_ENABLE
	/*==========================================
	 * [CreativeSD]: Restock System
	 *------------------------------------------*/
#include "../creativesd/restock/atcommand_def.inc"
#endif
#ifdef OSHOPS_ENABLE
	 /*==========================================
	  * [CreativeSD]: Organized Shops
	  *------------------------------------------*/
#include "../creativesd/oshops/atcommand_def.inc"
#endif
#ifdef COSTUME_SYSTEM_ENABLE
	 /*==========================================
	  * [CreativeSD]: Costume System
	  *------------------------------------------*/
#include "../creativesd/costume/atcommand_def.inc"
#endif
#ifdef AREALOOT_ENABLE
	 /*==========================================
	  * [CreativeSD]: Arealoot
	  *------------------------------------------*/
#include "../creativesd/arealoot/atcommand_def.inc"
#endif
#ifdef CREATIVE_ATCMD_ENABLE
	  /*==========================================
	   * [CreativeSD]: Others Atcommand
	   *------------------------------------------*/
#include "../creativesd/atcommand/atcommand_def.inc"
#endif
#ifdef REFINE_UI_ENABLE
		// Refine UI
		ACMD_DEF(refineui),
